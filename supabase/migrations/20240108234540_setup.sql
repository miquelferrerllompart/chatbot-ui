...
AS $$
DECLARE
  project_url TEXT := 'https://jbfjpqxzszuiyxzqmups.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpiZmpwcXh6c3p1aXl4enFtdXBzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzc1MTkwMywiZXhwIjoyMDIzMzI3OTAzfQ.Z0EXuY1uXEMzIMt9O0dfCuGzL7bzhDikTelr0KTFVqw'; -- full access needed for http request to storage
